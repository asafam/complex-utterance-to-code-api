...
from arguments import Text, DateTime, Contact, WeatherCondition
from typing import Callable, Optional, Iterator
from entity import ReminderEntity


class RemindersModel(Model):
    
    def __iter__(self) -> Iterator[ReminderEntity]:
        """
    ...
    def get_predicate(self, 
                      ...
                      todo: Optional[Text] = None,
                      op: ComparisonOperator = ComparisonOperator.EQ) -> Callable[[ReminderEntity], bool]:
        """
