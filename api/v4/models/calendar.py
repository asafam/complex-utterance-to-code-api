...
from arguments import Location, DateTime, Calendar, CalendarEvent
...
class CalendarModel(Model):
    ...
    def __iter__(self) -> Iterator[CalendarEntity]:
        """
    ...
    def get_predicate(self, 
                      ...
                      op: ComparisonOperator = ComparisonOperator.EQ) -> Callable[[CalendarEntity], bool]:
        """
